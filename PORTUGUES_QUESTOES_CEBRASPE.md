# Português — Questões Cebraspe e Pegadinhas

Arquivo vivo para registrar questões particularmente instrutivas, sobretudo quando a banca explora escopo, vinculação sintática, mudança de sentido em reescritas e distinções entre análise local e análise da estrutura completa.

---

## 1. “construção da mente de uma pessoa” → “construção mental de uma pessoa”

### Questão

Trecho:

> “Qualquer tentativa de retomá-los no presente, por meio de uma história, será uma representação, será uma **construção da mente de uma pessoa**. Logo, será uma ficção.”
